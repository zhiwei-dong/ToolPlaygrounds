...
# reference: https://github.com/fw-ai/cookbook/blob/main/examples/function_calling/fireworks_function_calling_demo.ipynb
# 兼容openai的方式启动

class FireFunction:
    def __init__(self, api='http://127.0.0.1:8000', parameters=None, model_name="firefunction-v2", **kwargs):
        base_url = f"{api}/v1"
        self.model_name = model_name
        self.client = OpenAI(api_key="FireFunction", base_url=base_url)
