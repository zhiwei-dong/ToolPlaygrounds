# todo: https://huggingface.co/glaiveai/glaive-function-calling-v1
from openai import OpenAI
import json

class GlaiveAI:
    def __init__(self, api='http://127.0.0.1:8000', parameters=None, model_name="glaive-function-calling-v1", **kwargs):
        base_url = f"{api}/v1"
        self.model_name = model_name
        self.client = OpenAI(api_key="glaive-function-calling", base_url=base_url)
